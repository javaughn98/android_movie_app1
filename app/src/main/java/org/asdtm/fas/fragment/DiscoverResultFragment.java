...
public class DiscoverResultFragment extends Fragment {
    ...
    // movie and tv show lists and info
    ...
    // Discover result fragment page views
    ...
    // creates a new fragment for the discover result page
    ...
    // creates a new page instance for the discover result page
    @Override
    ...
    // Creates a new visuals for the discover result fragment page and sets it up
    @Nullable
    @Override
    ...
    // filters the results by movies whenever in the search menu
    ...
    // Filters the search results by tv shows when in the search menu
    ...
    // adds a movie to the list of movies that is given
    ...
    // Adds a tv show to the list of TV shows given
    ...
    // shows or hides the status of the progress bar
    ...
    // Throws an error and shows error message whenever a page fails to load
    ...
    // clears and removes a page view
    @Override
